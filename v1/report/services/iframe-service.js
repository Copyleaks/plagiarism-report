        ...
        function (pageService) {
            ...
            function listenToMatchScrollRequest(){
                ...
                function receiveMessage(event) {
                    ...
                    //console.log('eventData.matchId:' + eventData.matchId + ' top:' + top + ', left:' + left, ', window.scrollY:' + window.scrollY);
                    window["removeCss"]();
                    ...
                    if (isInPdfDocument()) {
                        ...
                        console.log(pageContainingElement);
                        ...
                        console.log('eventData.matchId:' + eventData.matchId + ' pageTop:' + pageTop + ', left:' + left);
                        ...
                        setTimeout(function () {
                            ...
                            console.log('eventData.matchId:' + eventData.matchId + ' top:' + offset.top + ', left:' + offset.left);
                        },100)
                    }
                    else {
            ...
            function getIframeText(pageText) {
                ...
                var scriptContent = document.createTextNode("var cpyc = " + cpyc.toString() + ";" +
