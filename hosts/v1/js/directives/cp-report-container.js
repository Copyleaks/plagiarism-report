...
function attach_reportContainer(app) {
    ...
    function controller($scope, reportServiceListener, $routeParams, $route, $http, $q) {
        ...
        $scope.fillResults = function () {
            return $http.get('/hosts/v1/data/results.json').then(function (response) {
        ...
        $scope.fillInfo = function () {
            return $http.get('/hosts/v1/data/info.json').then(function (response) {
        ...
        $scope.fillDocument = function () {
            return getText('/hosts/v1/data/source-text.json')
        ...
        $scope.fillMatch = function (matchId) {
            ...
            var textPromise = getText('/hosts/v1/data/' + textJsonFileName); //get text
            var comparisonPromise = $http.get('/hosts/v1/data/' + comparisonJsonFileName); //get comparison
