					...
					text: {
						comparison: {
							identical: {
								source: {
									words: {
										...
										lengths: [3, 5, 4, 2, 0, 3, 19, 6, 2, 2, 3, 51, 20, 30, 16, 44, 0, 4, 3, 3, 44, 12, 35, 31, 45, 3, 3, 3, 4, 3, 3],
									},
								},
							},
							minorChanges: {
							...
							relatedMeaning: {
								source: {
									words: {
										starts: [5, 24, 35, 87, 89, 94, 98, 330, 333, 340, 355, 408, 492, 548, 549, 562, 583, 600, 601, 627],
