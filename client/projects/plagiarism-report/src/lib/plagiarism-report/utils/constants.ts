...
export const COMPLETE_RESULT_VALIDATION_ERROR = {
	errorText: 'Wrong argument supplied. Should be a CompleteResult.\n' +
...
export const NEW_RESULT_VALIDATION_ERROR = {
	errorText: 'Wrong argument supplied. Should be a NewResult.\n' +
...
export const SCAN_RESULT_VALIDATION_ERROR = {
	errorText: 'Wrong argument supplied. Should be a ScanResult.\n' +
...
export const SCAN_SOURCE_VALIDATION_ERROR = {
	errorText: 'Wrong argument supplied. Should be a ScanSource.\n' +
