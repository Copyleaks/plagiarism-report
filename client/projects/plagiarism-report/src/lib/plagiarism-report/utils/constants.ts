...
export const COMPLETE_RESULT_VALIDATION_ERROR = {
	...
	'For more info, visit https://api.copyleaks.com/documentation/v3/webhooks/completed' + '.',
	completeResult : {
		"status": 0,
...
export const NEW_RESULT_VALIDATION_ERROR = {
	...
	'For more info, visit https://api.copyleaks.com/documentation/v3/webhooks/new-result' + '.',
	completeResult : {
		"internet": [
		  {
			"id": "string",
...
export const SCAN_RESULT_VALIDATION_ERROR = {
	...
	'For more info, visit https://api.copyleaks.com/documentation/v3/downloads/result'  + '.',
	completeResult: {
		"statistics": {
		  "identical": 0,
		  "minorChanges": 0,
...
export const SCAN_SOURCE_VALIDATION_ERROR = {
	...
	'For more info, visit https://api.copyleaks.com/documentation/v3/downloads/source'  + '.',
	completeResult: {
		"metadata": {
		  "words": 30,
		  "excluded": 2
...
export const VERSION_VALIDATION_ERROR = {
	...
	`For more info, visit https://api.copyleaks.com/documentation/v${CURRENT_API_VERSION}`  + '.',
	completeResult: {version:`v${CURRENT_API_VERSION}`}
};
