 ...
 */
export function findRespectiveMatch(
	match: Match,
 ...
 */
export function findRespectivePage(start: number, pages: number[]): number {
	let page: number;
 ...
 */
export function findPartialMatch(match: Match, suspect: ComparisonCollection): number {
 ...
 */
export function findNextPageWithMatch(matches: SlicedMatch[][], current: number): number {
 ...
 * @param current the index of the current match
 */
export function findPrevPageWithMatch(matches: SlicedMatch[][], current: number): number {
